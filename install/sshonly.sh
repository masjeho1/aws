...
GitUser="masjeho"
wget https://raw.githubusercontent.com/${GitUser}/aws/main/install/hanyassh.sh && chmod +x hanyassh.sh && ./hanyassh.sh
wget https://raw.githubusercontent.com/${GitUser}/aws/main/websocketsshonly.sh && chmod +x websocketsshonly.sh && ./websocketsshonly.sh
