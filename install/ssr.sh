...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/masjeho1/vpn-script-shinjiru-/master/ssrmu"
...
Install_SSR
cd /usr/bin
wget -O /usr/bin/ssr https://raw.githubusercontent.com/masjeho1/vpn-script-shinjiru-/master/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O addssr https://raw.githubusercontent.com/masjeho1/aws/main/tambah/addssr.sh && chmod +x addssr
wget -O delssr https://raw.githubusercontent.com/masjeho1/aws/main/hapus/delssr.sh && chmod +x delssr
wget -O xp-ssr https://raw.githubusercontent.com/masjeho1/aws/main/xp-ssr.sh && chmod +x xp-ssr
wget -O renewssr https://raw.githubusercontent.com/masjeho1/aws/main/renewssr.sh && chmod +x renewssr
